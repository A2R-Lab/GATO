...
/**
 * @brief Kernel to compute dz from KKT system after solving for lambda.
 * 
 * @tparam T 
 * @param state_size 
 * @param control_size 
...
/**
 * @brief Computes dz from KKT system after solving for lambda.
 * 
 * @tparam T 
 * @param d_G_dense 
 * @param d_C_dense 
 ...
 */
template <typename T>
void compute_dz(T *d_G_dense, T *d_C_dense, T *d_g_val, T *d_lambda, T *d_dz){
