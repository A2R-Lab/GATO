...
docs/archaeology.md. NOTE: this is a Pinocchio-physics MPC baseline, not a CPU *solver* competitor
(it uses the GPU solver). Runs on Indy7 (the migrated Indy7 dynamics are validated)."""
import time
import math
import numpy as np
